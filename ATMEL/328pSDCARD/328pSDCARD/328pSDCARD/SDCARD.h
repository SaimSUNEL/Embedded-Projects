...
#define SS portb.RB2 //RA4 pini digital output used for ss of the slave device ( card reader )
unsigned char cevap  ;
...
void SDCARD_bir_sektor_yaz  ( unsigned long adres , byte * buff , int size )
{
